...
(function($) {
  ...
  function HopeAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  }; 

  HopeAjaxChosen.prototype.init = function() {
  ...
  HopeAjaxChosen.prototype.events = function() {
  ...
  HopeAjaxChosen.prototype.search_field_focused = function() {
  ...
  HopeAjaxChosen.prototype.search_welcome_message = function() {
  ...
  HopeAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = $.post("?act=theme_set&hope-chosen", _this.options.data).done(function(response) {
          _this.show_results(response.data)
      }).fail(function(response) {
         _this.container.find(".no-results").text(response.responseJSON.msg)
      });
    }, this.options.type_delay );

  };

  HopeAjaxChosen.prototype.show_results = function( items ) {
    ...
    this.element.find('option').each(function() {
      if ( $(this).is(':selected') ) {
        ...
        this.element.find("option").each(function() {
            $(this).is(":selected") ? s.push($(this).val() + "-" + $(this).text()) : $(this).attr("value").length && o(this).remove()
        }),
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.hope-hide-select');
  ...
  $.fn.HopeAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new HopeAjaxChosen(this, chosenOptions);
    });
  };
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('hope-depend-on');
        });
