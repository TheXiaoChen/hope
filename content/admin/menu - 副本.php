        ...
        <li class="list-group-item d-flex justify-content-between align-items-center" draggable data-id="<?= $child['id'] ?>">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu px-2 py-3" aria-labelledby="dropdownMenuButton">
                    ...
                    <li><a class="dropdown-item border-radius-md text-danger" href="javascript:;">删除</a></li>
                </ul>
            </div>
        </li>
				...
				<div class="d-lg-flex">
					...
					<div class="ms-auto my-auto mt-lg-0 mt-4">
						<div class="ms-auto my-auto">
							<button type="button" class="btn bg-gradient-primary btn-sm mb-0" data-bs-toggle="modal" data-id="" data-bs-target="#MenuModal">新建</button>
						</div>
					</div>
				</div>
			</div>
        ...
        <div class="card">
			<div class="card-body pb-3">
				<div class="d-lg-flex">
                    ...
                    <div class="ms-auto my-auto mt-lg-0 mt-4">
                        <div class="ms-auto my-auto">
                            <button type="button" class="btn bg-gradient-primary btn-sm mb-0" data-bs-toggle="modal" data-id="<?= $id ?>" data-bs-target="#AddMenuItemModal">新建</button>
                            <button type="button" class="btn btn-outline-secondary btn-sm mb-0 ms-2 save-order-btn" data-id="<?= $id ?>">保存排序</button>
                        </div>
                    </div>
				</div>
			</div>
        ...
        <div class="card">
			<div class="card-body pb-3">
				<div class="d-lg-flex">
                    ...
                    <div class="ms-auto my-auto mt-lg-0 mt-4">
                        <div class="ms-auto my-auto">
                            <button type="button" class="btn bg-gradient-primary btn-sm mb-0" data-bs-toggle="modal" data-bs-target="#SideModal">添加组件</button>
            ...
            <?php endforeach; ?>
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <span>官方
                        <br><a href="http://localhost/" title="http://localhost/" target="_blank">http://localhost/</a>
                    </span>
                    <div class="dropdown">
                        <span class="badge badge-primary badge-pill dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">操作</span>
                        <ul class="dropdown-menu px-2 py-3" aria-labelledby="dropdownMenuButton">
                            <li><a class="dropdown-item border-radius-md" href="javascript:;">编辑</a></li>
                            <li><a class="dropdown-item border-radius-md" href="javascript:;">新增子菜单项</a></li>
                            <li><a class="dropdown-item border-radius-md text-danger" href="javascript:;">删除</a></li>
                        </ul>
                    </div>
                </li>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="side_type" name="type_id" >
                            ...
                            <?php
                            require_once TEMPLATE_PATH . 'side.php';
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" name="target">
                            <option value="n">当前窗口</option>
                            <option value="y">新窗口</option>
                        </select>
                    </div>
                </div>
                <div class="modal-footer">
...
<script>
    ...
    // 根据 URL hash 激活对应菜单面板（支持 #menu5 或 #5 两种形式）
    ...
    $('#AddMenuItemModal').on('show.bs.modal', function (event) {
        ...
        modal.find('.modal-footer #item_id').val('')
        ...
        if (typeof itemId !== 'undefined' && itemId) {
            ...
            // 设置隐藏的 item_id
            modal.find('.modal-footer #item_id').val(itemId);
            // 修改 form action 为更新
    ...
    function monitorSideType() {
        ...
        $('#name').val(title);
        /*
        if (title && (!$('#name').val() || $('#name').val().trim() === '')) {
            $('#name').val(title);
        }*/
    }
